;DESCRIPCION:
;EJEMPLO DE COMUNICACIÓN SPI ENTRE 2 PICS: CODIGO DEL MASTER(AMO)
;EL RELOJ SERA FOSC/4, MODO DEL RELOJ 1,1 ==> CKP=1 Y CKE=0
;ENVIA LA LECTURA DEL PUERTOB CADA 300ms AL ESCLAVO Y LO QUE RECIBE
;EL AMO LO DESPLIEGA EN EL PUERTOD.
...
LOOP:				RETARDO_3V		.5,.86,.99			;RETARDO 300ms PARA FOSC 4MHZ
					BCF				PORTC,0				;ESCLAVO ACTIVO
			
					MOVF			PORTB,W
					MOVWF			SSPBUF				;ENVIAR EL VALOR DEL PUERTOB AL BUFFER SPI
					...
					MOVF			SSPBUF,W			;LEER LO QUE ESTA EN EL BUFFER SPI Y ENVIARLO A W
					MOVWF			PORTD				;ENVIAR LO QUE ESTA EN BUFFER AL PUERTO D
					BSF				PORTC,0				;DESHABILITAMOS ESCLAVO
					GOTO			LOOP
